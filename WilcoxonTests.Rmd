...
Wilcoxon tests allow for the testing of hypotheses about the value of the the __*median*__ when the test statistic doesn't follow any parametric distribution. They are often seen as 
nonparametric alternatives to the various t tests. However, they can also be used on ordinal data (data that is not quite quantitative, but is ordered) unlike t tests which require quantitative data.
